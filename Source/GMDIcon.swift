...
public enum GMDType: Int, EnumCollection {
    ...
    case gmdSystemUpdateAlt = 0xE8D7
    case gmdTab = 0xE8D8
    ...
    case gmdContentCopy = 0xE14D
    case gmdContentCut = 0xE14E
    case gmdContentPaste = 0xE14F
    ...
    case gmdFileDownload = 0xE2C4
    case gmdFileUpload = 0xE2C6
    ...
    case gmdDoNotDisturb = 0xE612
    case gmdDoNotDisturbAlt = 0xE611
