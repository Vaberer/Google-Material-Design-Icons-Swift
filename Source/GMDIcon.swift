...
public enum GMDType: Int, EnumCollection {
    ...
    //case gmdCopyright = 0x
    case gmdCreditCard = 0xE870
    case gmdDashboard = 0xE871
    case gmdDateRange = 0xE916
    case gmdDelete = 0xE872
    //case gmdDeleteForever = 0x
    //case gmdDeleteOutline = 0x
    case gmdDescription = 0xE873
    case gmdDns = 0xE875
    case gmdDone = 0xE876
    case gmdDoneAll = 0xE877
    //case gmdDoneOutline = 0x
    //case gmdDonutLarge = 0x
    //case gmdDonutSmall = 0x
    //case gmdDragIndicator = 0x
    ...
    //case gmdMotorcycle = 0x
    case gmdNoteAdd = 0xE89C
    //case gmdOfflineBolt = 0x
    ...
    //case gmdVoiceOverOff = 0x
    //case gmdWatchLater = 0x
    case gmdWork = 0xE8F9
    //case gmdWorkOff = 0x
    //case gmdWorkOutline = 0x
    ...
    //case gmdNotificationImportant = 0x
    case gmdWarning = 0xE002
    //case gmd4k = 0x
    //case gmdAddToQueue = 0x
    case gmdAirplay = 0xE055
    case gmdAlbum = 0xE019
    //case gmdArtTrack = 0x
    case gmdAvTimer = 0xE01B
    //case gmdBrandingWatermark = 0x
    //case gmdCallToAction = 0x
    case gmdClosedCaption = 0xE01C
    //case gmdControlCamera = 0x
    case gmdEqualizer = 0xE01D
    case gmdExplicit = 0xE01E
    case gmdFastForward = 0xE01F
    case gmdFastRewind = 0xE020
    //case gmdFeaturedPlayList = 0x
    //case gmdFeaturedVideo = 0x
    //case gmdFiberDvr = 0x
    //case gmdFiberManualRecord = 0x
    //case gmdFiberNew = 0x
    //case gmdFiberPin = 0x
    //case gmdFiberSmartRecord = 0x
    ...
    //case gmdMissedVideoCall = 0x
    case gmdMovie = 0xE02C
    //case gmdMusicVideo = 0x
    ...
    //case gmdPlaylistAddCheck = 0x
    //case gmdPlaylistPlay = 0x
    case gmdQueue = 0xE03C
    case gmdQueueMusic = 0xE03D
    //case gmdQueuePlayNext = 0x
    case gmdRadio = 0xE03E
    case gmdRecentActors = 0xE03F
    //case gmdRemoveFromQueue = 0x
    ...
    case gmdStop = 0xE047
    //case gmdSubscriptions = 0x
    case gmdSubtitles = 0xE048
    case gmdSurroundSound = 0xE049
    //case gmdVideoCall = 0x
    //case gmdVideoLabel = 0x
    ...
    //case gmdCallMissedOutgoing = 0x
    case gmdCallReceived = 0xE0B5
    case gmdCallSplit = 0xE0B6
    //case gmdCancelPresentation = 0x
    //case gmdCellWifi = 0x
    case gmdChat = 0xE0B7
    ...
    //case gmdMailOutline = 0x
    case gmdMessage = 0xE0C9
    //case gmdMobileScreenShare = 0x
    case gmdNoSim = 0xE0CC
    //case gmdPausePresentation = 0x
    //case gmdPersonAddDisabled = 0x
    ...
    //case gmdPrintDisabled = 0x
    case gmdRingVolume = 0xE0D1
    //case gmdRssFeed = 0x
    //case gmdScreenShare = 0x
    //case gmdSentimentSatisfiedAlt = 0x
    ...
    //case gmdStopScreenShare = 0x
    case gmdSwapCalls = 0xE0D7
    case gmdTextsms = 0xE0D8
    //case gmdUnsubscribe = 0x
    ...
    //case gmdHowToReg = 0x
    //case gmdHowToVote = 0x
    case gmdInbox = 0xE156
    case gmdLink = 0xE157
    //case gmdLinkOff = 0x
    //case gmdLowPriority = 0x
    case gmdMail = 0xE158
    case gmdMarkunread = 0xE159
    //case gmdMoveToInbox = 0x
    //case gmdNextWeek = 0x
    //case gmdOutlinedFlag = 0x
    case gmdRedo = 0xE15A
    ...
    //case gmdMobileFriendly = 0x
    //case gmdMobileOff = 0x
    ...
    //case gmdBubbleChart = 0x
    //case gmdDragHandle = 0x
    ...
    //case gmdFormatListNumberedRtl = 0x
    case gmdFormatPaint = 0xE243
    case gmdFormatQuote = 0xE244
    //case gmdFormatShapes = 0x
    ...
    //case gmdHighlight = 0x
    case gmdInsertChart = 0xE24B
    //case gmdInsertChartOutlined = 0x
    ...
    //case gmdLinearScale = 0x
    case gmdMergeType = 0xE252
    case gmdModeComment = 0xE253
    //case gmdMonetizationOn = 0x
    case gmdMoneyOff = 0xE25C
    //case gmdMultilineChart = 0x
    //case gmdNotes = 0x
    //case gmdPieChart = 0x
    case gmdPublish = 0xE255
    //case gmdScatterPlot = 0x
    //case gmdScore = 0x
    //case gmdShortText = 0x
    //case gmdShowChart = 0x
    case gmdSpaceBar = 0xE256
    case gmdStrikethroughS = 0xE257
    //case gmdTableChart = 0x
    //case gmdTextFields = 0x
    //case gmdTitle = 0x
    ...
    //case gmdDeviceUnknown = 0x
    //case gmdDevicesOther = 0x
    case gmdDock = 0xE30E
    ...
    case gmdToys = 0xE332
    case gmdTv = 0xE333
    //case gmdVideogameAsset = 0x
    case gmdWatch = 0xE334
    //case gmdAddAPhoto = 0x
    //case gmdAddPhotoAlternate = 0x
    ...
    //case gmd360 = 0x
    //case gmdAddLocation = 0x
    //case gmdAtm = 0x
    case gmdBeenhere = 0xE52D
    //case gmdCategory = 0x
    //case gmdCompassCalibration = 0x
    //case gmdDepartureBoard = 0x
    ...
    //case gmdEditAttributes = 0x
    //case gmdEditLocation = 0x
    //case gmdEvStation = 0x
    //case gmdFastfood = 0x
    ...
    //case gmdSubdirectoryArrowLeft = 0x
    //case gmdSubdirectoryArrowRight = 0x
    //case gmdUnfoldLess = 0x
    //case gmdUnfoldMore = 0x
    case gmdAdb = 0xE60E
    ...
    //case gmdWifiOff = 0x
    //case gmdAcUnit = 0x
    //case gmdAirportShuttle = 0x
    //case gmdAllInclusive = 0x
    //case gmdBeachAccess = 0x
    //case gmdBusinessCenter = 0x
    //case gmdCasino = 0x
    //case gmdChildCare = 0x
    //case gmdChildFriendly = 0x
    //case gmdFitnessCenter = 0x
    //case gmdFreeBreakfast = 0x
    //case gmdGolfCourse = 0x
    //case gmdHotTub = 0x
    //case gmdKitchen = 0x
    //case gmdMeetingRoom = 0x
    //case gmdNoMeetingRoom = 0x
    //case gmdPool = 0x
    //case gmdRoomService = 0x
    //case gmdRvHookup = 0x
    //case gmdSmokeFree = 0x
    //case gmdSmokingRooms = 0x
    //case gmdSpa = 0x
    case gmdCake = 0xE7E9
    ...
    //case gmdSentimentDissatisfied = 0x
    //case gmdSentimentSatisfied = 0x
    //case gmdSentimentVeryDissatisfied = 0x
    //case gmdSentimentVerySatisfied = 0x
    case gmdShare = 0xE80D
    //case gmdThumbDownAlt = 0x
    //case gmdThumbUpAlt = 0x
